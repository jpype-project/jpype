...
#define ASSERT_JVM_RUNNING(X) JPEnv::assertJVMRunning(X, __FILE__, __LINE__)
...
public :
	...
	static void rethrow(const char* file, int line);
};
...
#define PY_STANDARD_CATCH catch(...) { JPyErr::rethrow(__FILE__, __LINE__); }

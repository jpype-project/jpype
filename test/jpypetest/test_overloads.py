...
class OverloadTestCase(common.JPypeTestCase):
    def setUp(self):
        ...
        self._aclass = JClass('jpype.test.overloads.Test1$A')
        self._bclass = JClass('jpype.test.overloads.Test1$B')
        self._cclass = JClass('jpype.test.overloads.Test1$C')
        self._a = self._aclass()
        self._b = self._bclass()
        self._c = self._cclass()
        self._i1impl = JClass('jpype.test.overloads.Test1$I1Impl')()
        self._i2impl = JClass('jpype.test.overloads.Test1$I2Impl')()
        self._i3impl = JClass('jpype.test.overloads.Test1$I3Impl')()
        self._i4impl = JClass('jpype.test.overloads.Test1$I4Impl')()
        self._i5impl = JClass('jpype.test.overloads.Test1$I5Impl')()
        self._i6impl = JClass('jpype.test.overloads.Test1$I6Impl')()
        self._i7impl = JClass('jpype.test.overloads.Test1$I7Impl')()
        self._i8impl = JClass('jpype.test.overloads.Test1$I8Impl')()
    ...
    def testForceOverloadResolution(self):
        ...
        self.assertEqual('A', test1.testMostSpecific(
            JObject(self._c, 'jpype.test.overloads.Test1$A')))
        self.assertEqual('B', test1.testMostSpecific(
            JObject(self._c, 'jpype.test.overloads.Test1$B')))
        # JObject wrapper forces exact matches
        #self.assertRaisesRegex(TypeError, 'No matching overloads found', test1.testMostSpecific, JObject(self._c, 'jpype.test.overloads.Test1$C'))
    ...
    def testInterfaces1(self):
        ...
        self.assertEqual('I2', test1.testInterfaces1(
            JObject(self._i4impl, 'jpype.test.overloads.Test1$I2')))
        self.assertEqual('I3', test1.testInterfaces1(
            JObject(self._i4impl, 'jpype.test.overloads.Test1$I3')))
    ...
    def testClassVsObject(self):
        ...
        self.assertEqual('Class', test1.testClassVsObject(
            JClass('jpype.test.overloads.Test1$I4Impl')))
        self.assertEqual('Class', test1.testClassVsObject(
            JClass('jpype.test.overloads.Test1$I3')))
    ...
    def testDefaultMethods(self):
        try:
            testdefault = JClass('jpype.test.overloads.Test1$DefaultC')()
        except:
            pass
        else:
    ...
    def testDerivedStatic(self):
        ...
        DerivedTest = JClass("jpype.test.overloads.DerivedTest")

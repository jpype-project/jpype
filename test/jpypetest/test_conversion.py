...
class ConversionTestCase(common.JPypeTestCase):
    ...
    def testCanConvertExplicit(self):
        self.assertEqual(self.jc2.__javaclass__.canConvertToJava(1),"explicit")

    def testCanConvertImplicit(self):
        self.assertEqual(self.jc1.__javaclass__.canConvertToJava(None),"implicit")

    def testConvertExact(self):
        self.assertIsInstance(self.jc1.__javaclass__.convertToJava("a"), _jpype.PyJPValue)

    def testConvertImplicit(self):
        self.assertIsInstance(self.jc1.__javaclass__.convertToJava(None), _jpype.PyJPValue)

    def testConvertExplicit(self):
        self.assertIsInstance(self.jc2.__javaclass__.convertToJava(1), _jpype.PyJPValue)

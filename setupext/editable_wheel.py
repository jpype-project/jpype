...
from setuptools.command.editable_wheel import editable_wheel as editable_wheel_cmd


class EditableWheel(editable_wheel_cmd):
    user_options = editable_wheel_cmd.user_options + [
